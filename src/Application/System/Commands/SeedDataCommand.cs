...
public record SeedDataCommand : IMediatorRequest
{
    internal class Handler : IMediatorRequestHandler<SeedDataCommand>
    {
        ...
        private readonly IQuestSource _questSource;
        ...
        public Handler(ICrpgDbContext db, IItemsSource itemsSource, IApplicationEnvironment appEnv,
            ...
            IUserNotificationService userNotificationService, IQuestSource questSource)
        {
            _db = db;
        ...
        private async Task AddDevelopmentData(CancellationToken cancellationToken)
        {
            ...
            ActivityLog[] commonActivityLogs =
            {
                ...
                _activityLogService.CreateCharacterRewardedLog(orle.Id, takeo.Id, 5, 1000000),
                _activityLogService.CreateQuestRerolledLog(orle.Id, 1, 2, 350),
                _activityLogService.CreateQuestRewardClaimedLog(orle.Id, orleCharacter0.Id, 1, 10_000, 100_000),
            };
            ...
            ActivityLog[] gameServerActivityLogs =
            {
                ...
                new()
                {
                    ...
                    User = orle,
                    Metadata = { new("message", "Fluttershy is best"), new("instance", "crpg01a"), }
                },
                new()
                {
                    Type = ActivityLogType.ChatMessageSent,
                    User = orle,
                    Metadata = { new("message", "No, Rarity the best"), new("instance", "crpg01a"), },
                },
                new()
                {
                    Type = ActivityLogType.ChatMessageSent,
                    ...
                    Metadata = { new("message", "Do you get it?"), new("instance", "crpg01a"), },
                },
                new()
                {
                    ...
                    Metadata =
                    {
                        new("targetUserId", takeo.Id.ToString()),
                        new("damage", "123"),
                ...
                new()
                {
                    ...
                    Metadata =
                    {
                        new("targetUserId", namidaka.Id.ToString()),
                        new("damage", "333"),
                        new("instance", "crpg01a"),
                    },
                },
                new()
                {
                    Type = ActivityLogType.TeamHitReported,
                    User = orle,
                    CreatedAt = DateTime.UtcNow.AddMinutes(+6),
                    Metadata =
                    {
                        new("targetUserId", namidaka.Id.ToString()),
                        new("reportedHits", "333"),
                        new("decayedHits", "111"),
                        new("unreportedHits", "222"),
                        new("onReporterHits", "11"),
                        new("damage", "123"),
                        new("weaponName", "crpg_item_1"),
                    },
                },
                new()
                {
                    Type = ActivityLogType.TeamHitReportedUserKicked,
                    User = orle,
                    CreatedAt = DateTime.UtcNow.AddMinutes(+6),
                    Metadata =
                    {
                        new("reportedHits", "333"), new("decayedHits", "111"), new("unreportedHits", "222"),
                    },
                },
            };
            ...
            ActivityLog[] characterEarnedActivityLogs =
            {
                new()
                {
                    Type = ActivityLogType.CharacterEarned,
                    User = orle,
                    CreatedAt = DateTime.UtcNow.AddMinutes(-1),
                    Metadata =
                    {
                        new("characterId", orleCharacter0.Id.ToString()),
                        new("gameMode", "CRPGBattle"),
                        new("experience", "122000"),
                        new("gold", "1244")
                    }
                },
                new()
                ...
                new()
                {
                    ...
                    Metadata =
                    {
                        new("characterId", orleCharacter1.Id.ToString()),
                        new("gameMode", "CRPGDTV"),
                        new("experience", "32000"),
                        new("gold", "1989")
                    }
                },
                ...
                new()
                {
                    Type = ActivityLogType.CharacterEarned,
                    User = orle,
                    CreatedAt = DateTime.UtcNow.AddMinutes(-111),
                    Metadata =
                    {
                        new("characterId", orleCharacter0.Id.ToString()),
                        new("gameMode", "CRPGDTV"),
                        new("experience", "122234"),
                        new("gold", "-1222")
                    }
                },
                new()
                {
                    Type = ActivityLogType.CharacterEarned,
                    User = orle,
                    CreatedAt = DateTime.UtcNow.AddMinutes(-112),
                    Metadata =
                    {
                        new("characterId", orleCharacter0.Id.ToString()),
                        new("gameMode", "CRPGDTV"),
            ...
            UserNotification[] orleNotifications =
            {
                ...
                _userNotificationService.CreateClanArmoryBorrowItemToLenderNotification(orle.Id, pecores.Id,
                    orleItem1.ItemId, takeo.Id),
                _userNotificationService.CreateClanArmoryRemoveItemToBorrowerNotification(orle.Id, pecores.Id,
                    takeoItem1.ItemId, takeo.Id),
            };
        ...
        private async Task CreateOrUpdateItems(CancellationToken cancellationToken)
        {
            ...
            foreach (Item dbItem in dbItemsById.Values)
            {
                ...
                foreach (var userItem in userItems)
                {
                    ...
                    _db.ActivityLogs.Add(_activityLogService.CreateItemReturnedLog(userItem.User.Id, userItem.Item.Id,
                        userItem.Item.Rank, userItem.Item.Price));
                    _db.UserNotifications.Add(
                        _userNotificationService.CreateItemReturnedToUserNotification(userItem.User.Id,
                            userItem.Item.Id, userItem.Item.Rank, userItem.Item.Price));
                }
        ...
        {
            var questsById = (await _questSource.LoadQuests()).ToDictionary(i => i.Id);
