...
namespace Crpg.Persistence.Migrations
{
    ...
    [Migration("20260427004032_AddPerksData")]
    partial class AddPerksData
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("Crpg.Domain.Entities.Characters.CharacterCharacteristics", "Characteristics", b1 =>
                        {
                            ...
                            b1.OwnsOne("Crpg.Domain.Entities.Characters.CharacterPerks", "Perks", b2 =>
                                {
                                    b2.Property<int>("CharacterCharacteristicsCharacterId")
                                        .HasColumnType("integer")
                                        .HasColumnName("id");
                                    ...
                                    b2.Property<int>("Points")
                                        .HasColumnType("integer")
                                        .HasColumnName("perk_points");

                                    b2.PrimitiveCollection<int[]>("SelectedPerks")
                                        .IsRequired()
                                        .HasColumnType("integer[]")
                                        .HasColumnName("selected_perks");
